...
function Changeset(arg) {
    ...
    function assert(b, msg) {
        if (! b) error("Changeset: " + String(msg));
    }
    ...
    array.numStrips = function() {
        return (this.length - 3) / 3;
    };
    array.oldLen = function() {
        return this[1];
    };
    array.newLen = function() {
        return this[2];
    };
    ...
    function _makeAuthorSlicer(changesetOrAuthorsIn, builderOut) {
        ...
        function curAuthor() {
            return authors[authorPtr + 1];
        }

        function curAuthorWidth() {
            return authors[authorPtr];
        }

        function assertNotAtEnd() {
            assert(! atEnd, "_authorSlicer: can't move past end");
        }
    ...
    function _makeSlicer(C, output) {
        ...
        function curStartIndex() {
            return C[ptr];
        }

        function curNumTaken() {
            return C[ptr + 1];
        }
        ...
        function curStripWidth() {
            return curNumTaken() + curNewText().length;
        }

        function assertNotAtEnd() {
            assert(! atEnd, "_slicer: can't move past changeset end");
        }
